...
namespace OctoberStudio.UI
{
    ...
    {
        [SerializeField] StagesDatabase stagesDatabase;//关卡数据库

        [Space]
        [SerializeField] Image stageIcon;
        [SerializeField] Image lockImage;
        [SerializeField] TMP_Text stageLabel;//关卡名称标签
        [SerializeField] TMP_Text stageNumberLabel;//关卡编号标签
        ...
        public void InitStage(int stageId)
        {
            ...
            stageNumberLabel.text = $"阶段 {stageId + 1}";
