...
namespace OctoberStudio
{
    public class PlayerBehavior : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                //bool isPHeld = autoMoveHoldAction.IsPressed();
                //if (isPHeld != isAutoMoving)
                //{
                //    isAutoMoving = isPHeld;
                //}
                if (autoMoveHoldAction.IsPressed() || SseListenerMono.Focused || ReceiveBrainSignal.Focused)
                {
                    isAutoMoving = true;
                }
                else
